        ...
        drawer: Drawer(
          ...
          child: Padding(
            ...
            child: FutureBuilder<List<ListEstudoOuvindoavozdeDeusRow>>(
              future: ListEstudoOuvindoavozdeDeusTable().querySingleRow(
                queryFn: (q) => q,
              ),
              builder: (context, snapshot) {
                ...
                final columnListEstudoOuvindoavozdeDeusRow =
                    columnListEstudoOuvindoavozdeDeusRowList.isNotEmpty
                        ? columnListEstudoOuvindoavozdeDeusRowList.first
                        : null;
                return Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          'Aplicativo destinado a instrutores biblicos.',
                          style: FlutterFlowTheme.of(context).bodyMedium,
                        ),
                      ],
                    ),
