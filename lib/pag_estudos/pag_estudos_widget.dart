...
import 'pag_estudos_model.dart';
export 'pag_estudos_model.dart';

class PagEstudosWidget extends StatefulWidget {
  const PagEstudosWidget({Key? key}) : super(key: key);

  @override
  _PagEstudosWidgetState createState() => _PagEstudosWidgetState();
}

class _PagEstudosWidgetState extends State<PagEstudosWidget> {
  late PagEstudosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PagEstudosModel());
  }
